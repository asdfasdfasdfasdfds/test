...
const Panel = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      <img src={logo} className="w-72 md:w-96 mb-2" />
      <h1 className="text-4xl text-gray-800 font-extrabold mb-4">
        YETKİLİ PANELİ
      </h1>
      <div className="flex flex-col">
        <Link
          to="/kart/islemleri"
          className="w-72 text-center font-extrabold mb-4 bg-gray-800 text-white py-2 rounded-xl mt-2 hover:bg-gray-600 focus:outline-none focus:ring focus:ring-blue-200"
        >
          KART İŞLEMLERİ
        </Link>
        <Link
        ...
        <Link
          to="/anasayfa"
          className="w-72 text-center font-extrabold bg-gray-800 text-white py-2 rounded-xl hover:bg-gray-600 focus:outline-none focus:ring focus:ring-blue-200"
        >
          ANASAYFA
        </Link>
      </div>
